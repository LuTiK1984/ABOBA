...
void Good_Ending()
{
	PrintScript("\n\n\tМой недолгий сон прервал резкий звонок. %Посмотрев на экран телефона, я с трудом прочитал надпись \"Денисыч\". %");
	PrintScript("\nС явным недовольством я поднял трубку и произнес \"Ало\". %В ответ услышал осточертевший вопрос: \"Че ты мне не звонишь, не пишешь?\". %");
	PrintScript("\nКогда-же Серега придумает что-нибудь новое? %Дальше поступило предложение, от которого я просто не мог отказаться. %\nМеня проинформировали, что у меня есть 10 спичек на сборы, а ждать меня никто не собирается. %");
	PrintScript("\nЯ наскоро оделся, и поспешил выйти из дома, правда как обычно, Сереги еще не было. %\nПодождав пару минут у дома, в начале улицы я заметил свет фар знакомой десятки и мое настроение быстро поднялось. %");
	PrintScript("\nКогда машина подъехала поближе, я смог распознать лицо Денисыча за рулем, он наконец-то купил права. %\nОн резко затормозил, чуть не вмахавшись в забор моего дома. %");
	PrintScript("\nМесто спереди, на удивление, было свободно. %Я сел в десятку и увидел своих друзей. %\nСерега резво стартанул к неизвестному для меня месту назначения. %");
	PrintScript("\nЯ поинтересовался куда мы держим путь. %\nВ ответ я услышал - \"Секрет\". %\nПосле этих слов, я понял, что вечер пройдет в незабываемой, уютной обстановке. %");
	PrintScript("\n\n\t\tКОНЕЦЪ %", 20);
}

void Bad_Ending()
{
	PrintScript("\n\n\tТринадцать восьмеричных чисел окружили меня. %В густом лесу не было припоя. %Стена дождя ограждала меня от Ордынского Ига. %");
	PrintScript("\nНаш храбрый полководец Серега придумал новый план наступления. %На наших двумерных конях не было и намека на метафизическую оболочку утюга. %");
	PrintScript("\nОбильно обмазав свои клинки диоксином (термопастой), мы двинулись в бой... %\nНаша контратака проходила успешно, до момента пока ордынцы не попали Сереге в плече снежком... %");
	PrintScript("\nОн прокричал - \"ОН УБИЛ МЕНЯ... ОН МЕНЯ ПОДСТРЕЛИЛ... ВЫЗЫВАЙТЕ МИЛИЦИЮ, МЕНЯ ФУРА УБИЛА\". %\nЯ в панике заорал. %Стало светло. %Заснул опять. %\nСерега уже сидел за столом с алебардой и платочком. %");
	PrintScript("\nОн закрыл экран ладонью и глядел на меня широко раскрытыми глазами. %Телевизор чертил напротив в своих темных очках. %\nТак проходила каждая смена в КБ. %");
	PrintScript("\nСпустя еще пару бредовых видений, я понял, что это просто сон. %\nНо самым страшным мне покажется сон после того, как я проснусь. %");
	PrintScript("\n\n\tМеня разбудили несколько пощечин от прохожих. %Я открыл глаза и будто включился свет. %\nВсе пространство на пару мгновений стало темнее, чем было в ту секунду. %");
	PrintScript("\nИ тут ко мне вернулась утраченная память. %Я уже давно не учусь в универе... %\nМоя жизнь состоит из стояния за станком в полу-трезвом виде, да и сам я, кажется, уже на половину состою из крепкого алкоголя... %");
	PrintScript("\nБледный, с щетиной Серега спал на соседней лавке. %Локтем левой руки, он терзал свое эго. %\nЯ быстро огляделся. %Разбудивший меня мужик отпрыгнул от испуга, и убедившись, что со мной все в порядке, пошел дальше. %");
	PrintScript("\nВчера к нам с Серегой, видимо, заглянула белочка. %В последнее время частота ее посещений настораживала... %\nМне стало ясно, что наша скверная жизнь привела к тому, что даже белочка считает нашу лавку своим домом. %");
	PrintScript("\nЯ поежился, осознавая, что моя реальность – это жалкое отражение того, что когда-то было. %\nВремя теряло свой смысл, как и я сам, плывущий в этом бескрайнем океане алкогольного тумана. %");
	PrintScript("\nСерега, мой последний компаньон, продолжал терзать свое эго во сне, не подозревая, что мы, как и наш универ, стали прахом в вихре неудач и разочарований. %");
	PrintScript("\n\n\t\tКОНЕЦЪ %", 20);
}
#pragma region Act3
